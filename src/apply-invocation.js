describe("Apply() Invocation", function() {
    ...
    it("will have a `this` context of obj", function() {
        expect(test.apply(obj, ['johnny','horrible'])).toBe('johnny scored 500 and that is horrible');
    });

    it("will have a `this` context of obj2", function() {
        expect(test.apply(obj2, ['jimmy', 'great'])).toBe('jimmy scored 5000 and that is great');
    });
});
